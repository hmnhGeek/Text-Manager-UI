import { ADD_PLATFORM, ADD_PLATFORM_ERROR, ADD_PLATFORM_SUCCESS, RELOAD_PLATFORMS_PAGE, RELOAD_TITLES_PAGE } from "../constants/addPlatformConstants";
...
export const reloadTitlesPage = () => ({ type: RELOAD_TITLES_PAGE });